                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex">
                    {user?.notifications?.some(
                      ...
                      <button className="inline-flex items-center py-2 text-sm text-center text-white border-[1px] border-blue-600 rounded-full px-3 ">
                        Collaboration Sent
                      </button>
                    ) : (
                      <button
                        ...
                        className="inline-flex items-center py-2 text-sm text-center text-white bg-blue-600 rounded-full px-3"
                      >
                        Collaborate
                      </button>
                    )}
